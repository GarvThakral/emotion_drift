...
from pred_steps.preprocess_data_pred import preprocessing_data
from pred_steps.fetch_comments import fetch_comments
from pred_steps.predict import predict
from pred_steps.check_result import check_result
from pred_steps.check_drift import plot_drift
@pipeline
def predict_for_yt():
